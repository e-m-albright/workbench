...
- **Conventions** — does it respect the formatter, linter, package manager, naming, and house idioms? Take the project's stated conventions from its `AGENTS.md`/`CLAUDE.md` and surrounding code, not from assumptions.
