---
name: archify
description: Create validated system diagrams as standalone interactive HTML. Use for architecture maps, workflows, API sequences, data lineage, state machines, or polished Mermaid conversions.
license: MIT
...
Run `node bin/archify.mjs --help` before using the bundled command-line interface for the first time in a task.
...
- Adapted from [tt-a1i/archify](https://github.com/tt-a1i/archify/blob/0b636d9f2f410ce7c617dbfd8818b775d42e9d4d/archify/SKILL.md) (ported 2026-09-04, MIT).
