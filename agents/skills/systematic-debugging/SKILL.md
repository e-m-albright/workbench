...
description: Debug hard failures and performance regressions through reproduce, hypothesize, instrument, fix, and regression-test. Use when something is broken, flaky, slow, or resisting an obvious diagnosis.
metadata:
