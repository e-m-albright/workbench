...
- **Cursor Automations review (2026-08-26):** retained workflow patterns and primary sources live in [Agent Capability Patterns](knowledge/agent-capability-patterns.md#12-cursor-automations-patterns). The runtime rejection and revisit condition live in [tombstones](../docs/decisions/tombstones.md).
